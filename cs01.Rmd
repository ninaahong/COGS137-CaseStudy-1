...
To get a broad view of compound level in our dataset, we visualized the distribution of each compound across all data points. To track changes over time, we plotted compound levels in each fluid type by time intervals, allowing us to observe trends in a
